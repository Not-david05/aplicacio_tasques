    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              Checkbox(activeColor: Colors.teal[200],checkColor:Colors.orange[200] ,side:BorderSide(color:Colors.orange[200]!,width: 2),value: valorCheckbox, onChanged: (valorRebut){}),
              Text(
